    ...
    methods:{
        ...
        onUpDataEvent(event){
            if(event==="add")
            {
                ...
                if(!this.checkEventTmp(event))
                {
                    console.error("Addevent error due to incomplet data!",this.EventTmp);
                ...
                if(this.EventTmp.type==="dailycourse")
                {
                  ...
                  this.DailyCourse[this.DailyCourse.length]={
                  ...
                  this.DailyCourse.sort(function (a, b){
                ...
                else if (this.EventTmp.type==="dailystudy")
                {
                    ...
                    this.DailyStudy.sort(function (a, b){
                        var a_day=a.day,b_day=b.day;
                      if(a.day===0)
                      {
                          a_day=7; 
                ...
                {
                    console.log("work", this.EventTmp.deadline, this.WindowData.key);
                    ...
                    this.WorkProject.sort(function (a, b){
                ...
                else if(this.EventTmp.type==="sideproject")
                {
                    ...
                    this.SideProject.sort(function (a, b){
                        if(a.deadline.year<b.deadline.year)
                        {
                            return -1
                        }
            ...
            else if(event==="modify")
            {
               ...
               if(this.EventTmp.type=="dailycourse")
               {
                  for(var i=0;i<this.DailyCourse.length;++i)
                  {
                      console.log(this.DailyCourse[i], this.EventTmp.search_object);
               ...
               if(this.EventTmp.type=="dailystudy")
               {
                   for(var i=0;i<this.DailyStudy.length;++i)
                   {
               ...
               if(this.EventTmp.type=="todolist")
               {
               ...
               if(this.EventTmp.type=="workproject")
               {
                   for(var i=0;i<this.WorkProject.length;++i)
                   {
                       console.log(this.EventTmp.search_object,this.WorkProject[i])
               ...
               if(this.EventTmp.type=="sideproject")
               {
        ...
        checkEventTmp(event){
            ...
            else if(event==="delete"||event=="modify")
            {
